...
def getTicker(pair, connection=None, info=None, lmt=150):
    ...
    response = connection.makeJSONRequest("/api/3/ticker/%s?limit=%d" % (pair,lmt))
...
def getDepth(pair, connection=None, info=None, lmt = 150):
    ...
    response = connection.makeJSONRequest("/api/3/depth/%s?limit=%d" % (pair,lmt))
    if type(response) is not dict:
        raise TypeError("The response is not a dict.")
...
def getTradeHistory(pair, connection=None, info=None, count=None, lmt=150):
    ...
    response = connection.makeJSONRequest("/api/3/trades/%s?limit=%d" % (pair,lmt))
    if type(response) is not dict:
        raise TypeError("The response is not a dict.")
...
def getTradeHistoryJson(pair, connection=None, info=None, count=None, lmt=150):
    """Retrieve the trade history for the given pair.  Returns a list of
    Trade instances.  If count is not None, it should be an integer, and
    specifies the number of items from the trade history that will be
    processed and returned."""
...
def getTradeHistoryA(pair, connection=None, info=None, count=None, lmt=150):
    """Retrieve the trade history for the given pair.  Returns a list of
    Trade instances.  If count is not None, it should be an integer, and
    specifies the number of items from the trade history that will be
    processed and returned."""
